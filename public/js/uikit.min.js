/*! UIkit 3.15.14 | https://www.getuikit.com | (c) 2014 - 2022 YOOtheme | MIT License */ (function (
  ue,
  de
) {
            ...
            this.offsetBottom === !0
              ...
              : Dt(this.offsetBottom)
                ...
                : this.offsetBottom && Gt(this.offsetBottom, "px")
                  ...
                  : D(this.offsetBottom) &&
                    (i +=
                      " - " + $(ht(this.offsetBottom, this.$el)).height + "px"),
              (i += (s ? " - " + s + "px" : "") + ")");
          }
  ...
  function ts(t, e) {
    if (li(t)) {
      ...
      e &&
        !p(t.style.backgroundImage, e) &&
        (c(t, "backgroundImage", "url(" + Ei(e) + ")"), g(t, zt("load", !1)));
  }
